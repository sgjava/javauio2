...
public class Pin {
    ...
    /**
     * MMIO handle using FFM MemorySegment.
     */
    private MemorySegment mmioHandle;
     ...
     */
    public Pin(final PinKey key, final String groupName, final String name, final Register dataInOn,
            final Register dataInOff, final Register dataOutOn, final Register dataOutOff) {
        this.key = key;
