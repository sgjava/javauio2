...
/**
 * ST7789 drawImage performance demo using FFM.
 * <p>
 * This class measures the raw transfer speed of a static image to the ST7789 display. By utilizing the Foreign Function & Memory
...
@Command(name = "Perf", mixinStandardHelpOptions = true, version = "1.0.0-SNAPSHOT",
        description = "ST7789 drawImage performance demo using FFM")
public class Perf extends Base {
    ...
    public Integer call() throws Exception {
        ...
        for (var i = 0; i < samples; i++) {
            // This uses the FFM MemorySegment pipeline for ST7789
            lcd.drawImage(testImage);
        }
