...
public class SpriteDemo extends Base {
    ...
    public final void runDemo(final AbstractColorDisplay display) throws Exception {
        ...
        try (final var inputStream = SpriteDemo.class.getResourceAsStream(resourcePath)) {
            if (inputStream != null) {
    ...
    public static void main(final String... args) {
        System.exit(new CommandLine(new SpriteDemo()).execute(args));
    }
}
